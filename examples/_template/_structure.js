...
const {
  makeNutrientRecommendationTemplate,
} = require('./nutrient-recommendation-template.js');
const {
  makeNutrientReferenceRangeTemplate,
} = require('./nutrient-reference-range-template.js');
